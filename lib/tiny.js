        ...
        methods.forEach((name) => {
            ...
            if (handler.METHOD === MethodType.get) {
                ...
                if (handler.DATA_TYPE === DataType.other)
                    ...
                    router.post(path, koaBody(handler.DATA_TYPE_OPTIONS), handler);
            }
                ...
                if (handler.DATA_TYPE === DataType.other)
                    ...
                    router.put(path, koaBody(handler.DATA_TYPE_OPTIONS), handler);
            }
...
class Jwt {
    ...
    static sign(ctx, payload) {
        const token = jsonwebtoken.sign(Object.assign({}, payload), Jwt.options.privateKey, {
